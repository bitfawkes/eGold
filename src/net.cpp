...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "eGold " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.egoldcompany.org", "seed2.egoldcompany.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testseed1.egoldcompany.org", "testseed2.egoldcompany.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. eGold is probably already running."), addrBind.ToString().c_str());
        else
